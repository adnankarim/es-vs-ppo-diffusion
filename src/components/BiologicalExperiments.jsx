        ...
        <div style={{ backgroundColor: 'white', borderRadius: '0 0 16px 16px', padding: '32px' }}>
            ...
            {activeSubTab === 'ddpm' ? (
                <>
                    ...
                    <Section title="The BBBC021 Dataset: Structure & Strategy" number="4">
                        ...
                        <div style={{ marginBottom: '40px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '24px', marginBottom: '16px' }}>
                                <div style={{ textAlign: 'center' }}>
                                    <img src="/top_compounds.png" alt="Top Compounds Distribution" style={{ width: '100%', maxWidth: '600px', borderRadius: '8px', border: '1px solid #e2e8f0' }} />
                                    <p style={{ fontSize: '12px', color: colors.textLight, marginTop: '8px' }}>Figure 1: Distribution of top compounds.</p>
                                </div>
                                <div style={{ textAlign: 'center' }}>
                                    <img src="/split_counts.png" alt="Train/Test Split" style={{ width: '100%', maxWidth: '600px', borderRadius: '8px', border: '1px solid #e2e8f0' }} />
                        ...
                        <div style={{ marginBottom: '40px' }}>
                            ...
                            <img src="/dmso_vs_treated.png" alt="DMSO vs Treated Counts" style={{ width: '100%', maxWidth: '600px', display: 'block', margin: '0 auto 16px auto', borderRadius: '8px', border: '1px solid #e2e8f0' }} />
                        ...
                        <div style={{ marginBottom: '40px' }}>
                            ...
                            <img src="/batch_size_hist.png" alt="Batch Size Histogram" style={{ width: '100%', maxWidth: '600px', display: 'block', margin: '0 auto 16px auto', borderRadius: '8px', border: '1px solid #e2e8f0' }} />
                    ...
                    <Section title="Training Pipeline & Model Architecture" number="5">
                        ...
                        <div style={{ marginBottom: '40px', textAlign: 'center' }}>
                            <img src="/pipeline.png" alt="End-to-End Pipeline" style={{ width: '100%', maxWidth: '800px', borderRadius: '12px', border: '1px solid #e2e8f0', marginBottom: '16px' }} />
                ...
                <div style={{ padding: '64px', textAlign: 'center', color: colors.textLight }}>
                    ...
                    <h3 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '16px' }}>Flux Matching Experiments</h3>
                    <p style={{ maxWidth: '500px', margin: '0 auto', lineHeight: 1.6 }}>
                        This section is currently under development. It will contain results from our explorations into Stochastic Interpolants and Flow Matching for distribution alignment.
                    </p>
                </div>
            )}
